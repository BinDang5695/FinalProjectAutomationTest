...
public class WebUI {
	    ...
	    public static void assertContains(String actual, String expected, String message) {
	        ...
	        ExtentTestManager.logMessage(Status.INFO, "Assert contains: " + actual + " ↔\uFE0F " + expected);
	        boolean check = actual.contains(expected);
	    ...
	    public static boolean verifyEquals(Object actual, Object expected) {
	        ...
	        ExtentTestManager.logMessage(Status.INFO, "Assert equals: " + actual + " ↔\uFE0F " + expected);
	    ...
	    public static void waitUntil(By by, WaitType waitType) {
	        waitUntil(by, waitType, TIMEOUT);
	    }

	    public static void waitUntil(By by, WaitType waitType, int timeout) {
	        WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(timeout), Duration.ofMillis(500));
	        try {
	            switch (waitType) {
	                case VISIBLE:
	            ...
	            logConsole("❌ Timeout waiting for element with WaitType [" + waitType + "]: " + by);
	            Assert.fail("❌ Timeout waiting for element with WaitType [" + waitType + "]: " + by);
	        }
	    }    
}
